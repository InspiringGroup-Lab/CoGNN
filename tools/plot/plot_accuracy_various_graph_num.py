...
for dataset in datasets:
    ...
    cognn_test_accs.append(cognn_test_acc) 
    cognn_border_accs.append(cognn_border_acc) 
    ...
    fedgnn_test_accs.append(fedgnn_test_acc)
    fedgnn_border_accs.append(fedgnn_border_acc)
...
def plot_accuracies(fedgnn_test_acc, fedgnn_border_acc, save_path=None):
    ...
    for i in range(len(n_parts_list)):
        axs[0].plot(fedgnn_test_acc[i], label=f'FedGNN {n_parts_list[i]}p')
    ...
    for i in range(len(n_parts_list)):
        axs[1].plot(fedgnn_border_acc[i], label=f'FedGNN Border {n_parts_list[i]}p')
...
for i in range(len(datasets)):
    plot_accuracies(fedgnn_test_accs[i], fedgnn_border_accs[i], figure_root_path + "fedgnn-mp-accuracy." + datasets[i] + ".pdf") 
    # plot_accuracies(cognn_test_accs[i], cognn_border_accs[i], figure_root_path + "cognn-mp-accuracy." + datasets[i] + ".pdf")       
